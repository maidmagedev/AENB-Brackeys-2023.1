...
public class TongueAnimations : MonoBehaviour
{
    ...
    private enum AnimationStates { Walk, Attack }
    ...
    {
        [AnimationStates.Walk] = 0,
        [AnimationStates.Attack] = 1
    };

    // initial animation state
    private List<AnimationStates> priority = new List<AnimationStates>(new AnimationStates[] { AnimationStates.Walk });
